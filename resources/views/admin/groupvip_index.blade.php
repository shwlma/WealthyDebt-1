...
@section('content')
    ...
    <div class="container">
        ...
        <form id="filter-sort-form" class="filter-sort-section" action="{{ route('admin.groupvip') }}" method="GET">
            <div>
                <label for="search">Search by Name:</label>
                {{-- Removed oninput here; debounce handled by JavaScript --}}
    ...
    <script>
        ...
        function applyFiltersAndSort() {
            ...
            const baseUrl = "{{ route('admin.groupvip') }}"; // Changed to admin.groupvip
        ...
        function setExportLink() {
            ...
            const exportBaseUrl = "{{ route('admin.groupvip.export') }}"; // Changed to admin.groupvip.export
