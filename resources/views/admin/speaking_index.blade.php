...
@section('content')
    <div class="container">
        ...
        <form id="filter-sort-form" class="filter-sort-section" action="{{ route('admin.speaking') }}" method="GET">
            <div>
    ...
    <script>
        ...
        function applyFiltersAndSort() {
            ...
            const baseUrl = "{{ route('admin.speaking') }}"; // Changed to admin.groupvip
        ...
        function setExportLink() {
            ...
            const exportBaseUrl = "{{ route('admin.speaking.export') }}"; // Changed to admin.groupvip.export
