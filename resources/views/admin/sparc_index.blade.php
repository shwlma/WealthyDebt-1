...
@section('content')
    <div class="container">
        ...
        <form id="filter-sort-form" class="filter-sort-section" action="{{ route('admin.sparc') }}" method="GET">
            <div>
    ...
    <script>
        ...
        function applyFiltersAndSort() {
            ...
            const baseUrl = "{{ route('admin.sparc') }}"; // Changed to admin.groupvip
        ...
        function setExportLink() {
            ...
            const exportBaseUrl = "{{ route('admin.sparc.export') }}"; // Changed to admin.groupvip.export
