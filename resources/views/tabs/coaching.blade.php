...
<body>
    ...
    <main>
        <section id="group-vip" class="session-section gold-bg">
            <div class="container">
                ...
                <div class="content-block">
                    <h4>What This Is:</h4>
                    <p>This is your chance to experience strategic guidance from a financial expert — at a lower
                        investment — in a high-impact group setting.</p>
                    <p>You’ll get the same depth of insight offered in our $350 SPARC Session, but in a shared space
                        where you’ll learn from real-time questions, guided teaching, and your own self-reflection.</p>
                    <p><strong>This is not a coaching circle.</strong></p>
                    <p>This is a focused, fast-moving, strategy-packed hour designed to help you shift your mindset,
                        identify opportunity, and take smart financial action — especially for your business.</p>
                </div>
                ...
                <div class="content-block">
                    ...
                    <ul>
                        <li>A breakdown of the Wealthy Debt™ Framework — and how to use it to strengthen your financial
                            foundation</li>
                        <li>A new lens on how your current business income, debt, or gaps can actually be leveraged</li>
                        <li>Insight into how tools like life insurance, business structuring, and trust planning apply
                            to your stage of growth</li>
                ...
                <div class="content-block">
                    ...
                    <ul>
                        ...
                        <li>A custom Strategic Wealth Action Plan sent to your inbox the next business day, which
                            includes:
                            <ul>
                ...
                <div class="content-block">
                    ...
                    <blockquote class="testimonial">
                        “I left with ideas I’d never considered — and a strategy that makes sense for where I am right
                        now.”
                    </blockquote>
                </div>
                ...
                <div class="cta-area">
                    ...
                    <a href="https://buy.stripe.com/test_9B66oJ1En2Oh9jLeDN14403" class="cta-button primary-cta">Enroll
                        in Group VIP ($175)</a>
        ...
        <section id="consulting-session" class="session-section white-bg">
            <!-- Note: was .session-section:nth-child(even), now explicit class for clarity if sections reorder -->
            <div class="container">
                <div class="session-intro">
                    <h2>Consulting Session — Real Answers. Real Fast.</h2>
                    <p class="price-tag">Price: $150 <span class="duration">(Duration: 45 minutes - Live on Zoom)</span>
                    </p>
                ...
                <div class="content-block">
                    ...
                    <p>This 45-minute Consulting Session is a focused, fast-paced strategy call designed to cut through
                        confusion and give you direction. Whether you’re building a business, launching a new idea, or
                        just trying to make smarter moves, this is your window to clarity.</p>
                </div>
                ...
                <div class="content-block">
                    ...
                    <blockquote class="testimonial">
                        “I didn’t need a course. I needed someone to help me stop overthinking and just take action.
                        This 45-minute session changed everything.”
                    </blockquote>
                </div>
                ...
                <div class="cta-area">
                    ...
                    <p>This session is live, confidential, and built for those who show up.<br>
                        To protect your privacy — and my future programs — the session will not be recorded or replayed.
                    </p>
                    <!-- IMPORTANT: Replace #YOUR_STRIPE_LINK_CONSULTING with your actual Stripe payment link -->
                    <a href="https://buy.stripe.com/test_7sY7sN6YH0G967zbrB14404" class="cta-button gold-cta">Book
                        Consulting Session ($150)</a>
                    <p class="stripe-info">(Secure Payment via Stripe)</p>
                </div>
            </div>
        </section>
